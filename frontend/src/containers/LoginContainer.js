...
const LoginContainer = (props) => {
  ...
  useEffect(() => {
    if (authReducer.isAuthenticated) {
      if (/\/courses-login\/?$/.test(pathname)) {
        history.push(`/academy/${program}/courses-list`);
      } else if (/\/packs-login\/?$/.test(pathname)) {
        history.push(`/academy/${program}/packs`);
      } else if (/\/login-academy\/?$/.test(pathname)) {
        history.push(`/academy/${program}`);
      } else if (/\/login\/?$/.test(pathname)) {
        history.push(`/academy/${program}/book-class`);
      }
    }
