...
import AcquireInstructorAccounts from "../../components/AdminAcademy/AcquireInstructorAccounts";
const InstructorAccountsAdmin = () => {
...
`;
export default InstructorAccountsAdmin;
