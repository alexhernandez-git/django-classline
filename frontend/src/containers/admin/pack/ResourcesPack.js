...
import FileForm from "src/components/AdminAcademy/FileForm";
import ShareForm from "src/components/AdminAcademy/ShareForm";
import {
  createFolder,
  fetchFolders,
  deleteFolders,
  ...
  fetchTopFolders,
  removeCurrentFolder,
} from "src/redux/actions/folders";
import { fetchFiles, createFile, deleteFiles } from "src/redux/actions/files";
...
export default function ResourcesPack() {
