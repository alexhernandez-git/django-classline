...
const TeachersProfileImage = () => {
    ...
    const cropImage = () => {
        ...
        var file = dataURLtoFile(cropper.current.getCroppedCanvas().toDataURL("image/jpeg",0.7), appContext.userProfile.user.id + appContext.userProfile.user.first_name + fileName);
