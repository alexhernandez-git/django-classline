          ...
          <>
            <Form>
              <div className="border-bottom d-sm-flex justify-content-between p-2">
                ...
                <Link
                  to="/myzone/instructor/programs"
                  className="btn-green py-2 px-3 text-white"
                >
                  Volver
                </Link>
                ...
                >
                  <span
                    className="h4 mb-0 text-grey  text-center"
                    style={{
                      overflow: "hidden",
                      textOverflow: "ellipsis",
                      display: "webkitBox",
                ...
                <button
                  type="submit"
                  className="btn-green py-2 px-3 text-white btn-sm-block beat"
                >
                  Crear
                </button>
              </div>
