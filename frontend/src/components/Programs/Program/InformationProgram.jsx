...
import { FaChalkboardTeacher, FaCheck,  FaVideo,FaPodcast,FaListUl } from 'react-icons/fa';
        ...
        <ProgramContext.Consumer>
            {programContext => (
                <div className="teacher-teach border bg-light w-100 p-4 rounded mb-3 text-dark">
                    <span className="d-block h4 font-weight-normal text-primary">Información</span>
                    <div className="mt-2">
                        ...
                        <div className="row pr-3 pl-3 mt-3">
                            <div className="col-sm-6 d-flex align-items-center">
                                ...
                                <span className="m-0 text-center text-primary font-weight-normal">Número de videos</span>
                        ...
                        {programContext.programState.program.are_playlists &&
                            <div className="row pr-3 pl-3 mt-3">
                                <div className="col-sm-6 d-flex align-items-center">
                                    ...
                                    <span className="m-0 text-center text-primary font-weight-normal">Numero de playlists</span>
                        ...
                        {programContext.programState.program.are_podcasts &&
                            <div className="row pr-3 pl-3 mt-3">
                                <div className="col-sm-6 d-flex align-items-center">
                                    ...
                                    <span className="m-0 text-center text-primary font-weight-normal">Numero de podcasts</span>
                        ...
                        {programContext.programState.program.are_meetups &&
                            <div className="row pr-3 pl-3 mt-3">
                                <div className="col-sm-6 d-flex align-items-center">
                                    ...
                                    <span className="m-0 text-center text-primary font-weight-normal">Numero de videoconferencias</span>
