    ...
    <>
      <div className="bg-white border p-3 rounded my-2 mb-4">
        ...
        <Row className="mb-4">
          ...
          >
            {authCommercialsReducer.user.commercial.stripe_account_id == null ||
            authCommercialsReducer.user.commercial.stripe_account_id ==
              undefined ? (
              <>
          ...
          <Col sm={{ offset: 1, span: 6 }}>
            ...
            authCommercialsReducer.user.commercial.stripe_account_id ==
              ...
              <>
                ...
                <a
                  href={
                    authCommercialsReducer.user.commercial.stripe_dashboard_url
                  }
                  target="_blank"
                >
