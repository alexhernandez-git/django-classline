...
# Models
from api.programs.models import Program, LectureMaterial
...
class LectureMaterialViewSet(mixins.CreateModelMixin,
    ...
    serializer_class = LectureMaterialModelSerializer
    lookup_field = 'id'
