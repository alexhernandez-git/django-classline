    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('first_password', models.CharField(blank=True, max_length=40, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='teacher_coupons', to='users.Coupon')),
                ('subscriptions', models.ManyToManyField(related_name='instructor_subscriptions', to='users.Subscription')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subscriptions', models.ManyToManyField(related_name='student_subscriptions', to='users.Subscription')),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'ordering': ['-created', '-modified'],
